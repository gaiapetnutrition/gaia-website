...
const ACTIVITY_STEPS = [
  ...
  { id: 'low_plus',      anchor: null,          desc: 'לא פעיל+ - כלב עם שגרה ביתית רגועה מאוד, רגיש לעומס, טיולים קצרים עם גירויים פיזיים ומנטלים קטנים.'                },
  { id: 'moderate',      anchor: 'רגיל',       desc: 'רגיל - כלב בית טיפוסי, נהנה מטיול יומי ומשחקים פשוטים, רמת פעילות מתונה.'                        },
  { id: 'moderate_plus', anchor: null,          desc: 'רגיל+ - כלב עם יותר אנרגיה וגירוי, טיולים ומשחקים יומיים מגוונים, בשגרה פעילה לסירוגין.'              },
  { id: 'active',        anchor: 'פעיל',       desc: 'פעיל - כלב הזקוק לטיולים ארוכים יותר, ריצות קצרות או משחק אנרגטי כמה פעמים בשבוע.'            },
...
עם זאת!
לכל כלב גוף, חילוף חומרים וצרכים אישיים משלו, ולכן יש להתייחס לתוצאה כנקודת פתיחה בלבד. הכמות בפועל עשויה להשתנות בהתאם להוצאה האנרגטית היומית, לרמת הפעילות, למצב הבריאותי ולשינויים בשגרה. בדיוק כפי שהתזונה והכמות שאנו אוכלים משתנות מיום ליום בהתאם לצרכים שלנו, כך גם צריכת המזון של כלב עשויה להשתנות ואין כמות אחת קבועה לכל כלב.

חשוב לעקוב לאורך זמן אחר משקל הכלב, מצב הגוף, רמת האנרגיה והיציאות - ולהתאים את הכמות בהתאם. לא מחליף אבחון וייעוץ עם וטרינר/ית או תזונאי/ת.`}
              </p>
            </div>
            <img
