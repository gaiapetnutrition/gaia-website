...
כולין פועל בשיתוף עם חלבון, מתיונין, פולאט וויטמין B12-לכן בוחנים את התזונה השלמה, ולא רק את המספר שלו במחשבון.`,
  Copper: `נחושת היא מינרל קורט שמפעיל אנזימים חיוניים לייצור אנרגיה בתאים, ניצול ברזל ויצירת תאי דם אדומים, בניית רקמות חיבור ויצירת פיגמנט בפרווה. מחסור ממושך עלול להתבטא באנמיה, ירידה באיכות או בהעמקת צבע הפרווה, פגיעה בגדילה ובחוזק רקמות החיבור ולעיתים חולשה או בעיות עצביות.
