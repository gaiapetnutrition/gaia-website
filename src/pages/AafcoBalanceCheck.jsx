    ...
    <div className="bg-white border border-stone rounded-3xl shadow-card overflow-hidden">
      ...
      {open && (
        <div className="px-5 pb-5 text-xs text-mist leading-relaxed space-y-2 border-t border-stone/60 pt-4">
          <p>
            AAFCO הוא הארגון המקצועי שקובע את פרופילי התזונה המלאה והמזינה לכלבים וחתולים, על בסיס מחקרים ותצפיות ארוכות שנים. הפרופילים שלהם הם היום למעשה הקו המנחה העיקרי בעולם שמגדיר את המינימום לתזונה מלאה ומאוזנת — כלומר רמות מינימום של ויטמינים ומינרלים שמתחתיהן נצפו תסמיני חוסרים ומחלות.
          </p>
          <p>
