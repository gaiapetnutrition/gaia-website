...
חוסר ממושך עלול לגרום לירידה במשקל ולחולשה, האטה בגדילה אצל גורים, בעיות עור ופרווה ופצעים בפה. במצב משמעותי יותר עלולות להופיע בעיות עיניים, הליכה לא יציבה ואנמיה.`,
  Selenium: `סלניום הוא מינרל שעוזר להגן על תאי הגוף מנזק חמצוני, ותומך בשרירים, במערכת החיסון ובפוריות. הוא פועל יחד עם ויטמין E, ולכן שניהם חשובים לשמירה על תאים ורקמות בריאות.

חוסר ממושך עלול לגרום לחולשת שרירים, עייפות, ירידה בתיאבון ופגיעה בהתאוששות הגוף. במצב חמור - במיוחד כשיש גם חוסר בוויטמין E -עלולה להיגרם פגיעה בשרירים, כולל בשריר הלב. גם עודף סלניום עלול להזיק, לכן חשוב מאוד לדייק בכמות.`,
  Thiamine: `תיאמין עוזר לגוף להפיק אנרגיה מפחמימות, והוא חיוני במיוחד לתפקוד המוח, מערכת העצבים, הלב והשרירים.

חוסר ממושך עלול להתחיל בירידה בתיאבון, הקאות, עייפות וירידה במשקל. אם הוא מחמיר, הוא עלול לפגוע במערכת העצבים ולגרום לחוסר יציבות בהליכה, חולשה, פרכוסים, ירידה במצב ההכרה ואף לסכנת חיים.`,
  'Vitamin A': `ויטמין A חיוני לראייה, במיוחד בתאורה חלשה, ולבריאות העור, הפרווה, מערכת החיסון והגדילה. הוא גם עוזר לשמור על ריריות תקינות בעיניים, בדרכי הנשימה ובמערכת העיכול.

חוסר ממושך עלול לגרום לקושי לראות בחושך, עיניים יבשות או מגורות, עור יבש ופרווה דהויה, ירידה במשקל ונטייה גבוהה יותר לזיהומים. אצל גורים הוא עלול לפגוע בגדילה ובהתפתחות העצמות. גם עודף ויטמין A מזיק, לכן חשוב לדייק במיוחד בתפריטים המכילים כבד.`,
  'Vitamin B-12': `ויטמין B12 חיוני ליצירת תאי דם אדומים, לתפקוד מערכת העצבים ולחידוש תאים. הוא גם תומך בשימוש בחלבון ובשומן ובהפקת אנרגיה מהמזון.

כאשר התזונה דלה ב־B12 לאורך זמן, הכלב עלול לפתח ירידה בתיאבון, עייפות, ירידה במשקל, הקאות או שלשול. מחסור משמעותי עלול לגרום לאנמיה, לפגיעה בגדילה ובמצב הגוף, ובמקרים מתקדמים גם לחולשה או בעיות עצביות.`,
  'Vitamin D': `ויטמין D עוזר לגוף לספוג סידן וזרחן מהמזון, ולכן הוא חיוני לעצמות, לשיניים ולשרירים חזקים. כלבים תלויים בעיקר בוויטמין D מהמזון, ולא מייצרים ממנו כמות מספקת מחשיפה לשמש.

חוסר ממושך עלול לגרום לעצמות רכות וחלשות, כאבים, צליעה ושברים. אצל גורים הוא עלול לפגוע בגדילה ולגרום לעיוותים בשלד; במצבים חמורים, ירידה בסידן בדם עלולה לגרום לרעידות שרירים או לפרכוסים. גם עודף ויטמין D מסוכן, ולכן יש לדייק מאוד בכמות בתפריט.`,
  'Vitamin E': `ויטמין E הוא נוגד חמצון שמגן על תאי הגוף מפני נזק, במיוחד בתאים של שרירים, עצבים ועור. הוא גם תומך במערכת החיסון ופועל יחד עם סלניום.

חוסר ממושך עלול לגרום לחולשת שרירים, עייפות, כאב או נוקשות בתנועה ופגיעה בתפקוד העצבים. במצבים חמורים עלולה להיפגע גם רקמת השומן או שריר הלב. הסיכון עולה כשהתפריט עשיר בשומנים בלתי רוויים אך דל בוויטמין E.`,
  Zinc: `אבץ הוא מינרל חיוני לגדילה, לתפקוד מערכת החיסון, לריפוי פצעים ולבריאות העור והפרווה. הוא משתתף בפעילות של אנזימים רבים ובחידוש תקין של תאים.

חוסר ממושך עלול לגרום לעור יבש, קשקשי או עם גלדים - במיוחד סביב העיניים, הפה וכפות הרגליים - לנשירת שיער ולריפוי איטי של פצעים. אצל גורים הוא עלול לגרום להאטה בגדילה, שלשול ונטייה גבוהה יותר לזיהומים.`,
  Chloride: `כלוריד הוא אלקטרוליט שפועל יחד עם נתרן ואשלגן כדי לשמור על מאזן הנוזלים ועל רמת החומציות התקינה בגוף. הוא גם מרכיב בחומצת הקיבה, ולכן חשוב לעיכול חלבונים.

חוסר ממושך עלול להפר את מאזן הנוזלים והמלחים ולגרום לחולשה, עייפות, רעד שרירים, התייבשות והפרעות בעיכול. חוסר תזונתי בכלוריד אינו שכיח בתפריט מאוזן, אך הוא יכול להופיע גם לאחר הקאות ממושכות, שבהן הגוף מאבד חומצת קיבה.`,
  Magnesium: `מגנזיום הוא מינרל חיוני לפעילות עצבים ושרירים, ליצירת אנרגיה ולבניית עצמות. הוא גם עוזר לשמור על איזון תקין של סידן ואשלגן בגוף.

חוסר ממושך עלול לגרום לחולשה, עייפות, רעידות או קפיצות שרירים וחוסר יציבות בהליכה. במצב חמור עלולות להופיע הפרעות בקצב הלב, פרכוסים או ירידה ברמות הסידן והאשלגן.`,
  Phosphorus: `זרחן עובד יחד עם סידן לבניית עצמות ושיניים חזקות. הוא גם חיוני לייצור אנרגיה בתאים, לתפקוד השרירים ולשמירה על מאזן החומציות בגוף.

חוסר ממושך עלול לגרום לירידה בתיאבון, עייפות, חולשת שרירים וירידה במשקל. אצל גורים הוא עלול לעכב גדילה ולהוביל לעצמות רכות או מעוותות, ובמצבים חמורים גם לצליעה, כאב ושברים. חשוב לשמור לא רק על כמות מספקת, אלא גם על יחס מאוזן בין זרחן לסידן.`,
  Potassium: `אשלגן הוא אלקטרוליט חיוני לפעילות התקינה של השרירים, העצבים והלב. הוא גם עוזר לשמור על מאזן הנוזלים בתוך התאים.

חוסר ממושך עלול לגרום לחולשה, עייפות, קושי לקום או ללכת, ירידה בתיאבון ועצירות. במצב חמור הוא עלול לשבש את קצב הלב ולפגוע גם בשרירי הנשימה, ולכן יכול לדרוש התייחסות וטרינרית.`,
  Protein: `חלבון מספק לכלב חומצות אמינו לבניית שרירים, עור, פרווה, איברים ואנזימים, והוא גם חיוני למערכת החיסון ולתיקון רקמות. לא רק הכמות חשובה - גם איכות החלבון והאם הוא מספק את חומצות האמינו החיוניות.

חוסר ממושך עלול לגרום לירידה במסת השריר ובמשקל, חולשה, פרווה דהויה, החלמה איטית מפצעים ונטייה גבוהה יותר לזיהומים. אצל גורים הוא עלול לעכב גדילה. במצב חמור, ירידה בחלבוני הדם יכולה לגרום לבצקות או לנוזלים בבטן.`,
  Sodium: `נתרן הוא אלקטרוליט חיוני שפועל עם כלוריד ואשלגן לשמירה על מאזן הנוזלים בגוף. הוא גם הכרחי להעברת אותות עצביים, להתכווצות שרירים ולפעילות תקינה של הלב.

חוסר ממושך עלול לגרום לעייפות, חולשה, ירידה בתיאבון, הקאות וחוסר יציבות בהליכה. במצב חמור הוא עלול לפגוע בתפקוד המוח ולגרום לרעידות, בלבול, פרכוסים או קריסה.`,
  'Total fat': `שומן הוא מקור אנרגיה מרוכז, והוא נחוץ לספיגת ויטמינים A, D, E ו־K, לבניית תאים ולבריאות העור והפרווה. הוא גם מספק חומצות שומן חיוניות, כמו אומגה־6 ואומגה־3, שהכלב חייב לקבל מהמזון.

תזונה דלה מדי בשומן לאורך זמן עלולה לגרום לעור יבש וקשקשי, פרווה דהויה או דלילה, נשירה וריפוי איטי של פצעים. אצל גורים היא עלולה לפגוע בגדילה, ובכלבים בוגרים גם בפוריות ובתפקוד התקין של מערכת החיסון.`,
}
