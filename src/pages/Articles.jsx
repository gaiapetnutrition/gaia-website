...
const ARTICLES = [
  {
    ...
    body: [
      ...
      { type: 'p', text: 'הגוף המרכזי שטבע את המונח הוא AAFCO בארה״ב. באירופה קיים גוף מקביל בשם FEDIAF, וההמלצות שלהם מבוססות על גוף ידע מדעי רחב, ובין היתר על עבודתו של ה-NRC - המועצה למחקר בתחום הדרישות התזונתיות של כלבים וחתולים, שביצעו מחקרים בנושא לאורך שנים.' },
      ...
      { type: 'p', text: 'וזה בדיוק העניין: ברגע שאנחנו בונים את ה"טרף" בעצמנו, האחריות לוודא שלא חסרים נוטריאנטים עוברת אלינו.' },
      { type: 'p', text: 'והאמת היא, שלרוב חסר - מחקר של אוניברסיטת UC Davis ניתח מעל 200 דיאטות ביתיות לכלבים - 95% מהן לא היו מלאות ומאוזנות, כלומר, היו חסרות בלפחות נוטריאנט אחד.' },
      ...
      { type: 'p', text: 'כן, הספיגה של מזון טבעי לרוב גבוהה יותר ותמיד נעדיף מזון אמיתי. מצד שני, למשל, יש מקרים בהם נוטריאנטים טהורים ומבודדים יכולים להיות זמינים מאוד לספיגה, בעוד שדווקא בתוך מזון שלם יכולים להיות רכיבים שמפחיתים את זמינותם כמו אוקסלטים או חומצה פיטית.' },
      { type: 'p', text: 'לכן, אם אנחנו מאמינים שתזונה טבעית מספקת נוטריינטים בצורה זמינה ואיכותית, אין סיבה שהיא לא תוכל לעמוד לפחות ברמות התזונתיות המקובלות כרשת ביטחון. ועד שלא יהיה לנו מחקר ברור של רמות נוטריאנטים מינימליות ומקסימליות במזון טבעי, אין מניעה שנקבע לעצמנו מטרה לעמוד בתנאים שהתווה גוף המחקר היחיד שקיים היום, במיוחד אם האלטרנטיבה היא לנחש או ללכת לפי אינטואיציה או טרנדים.' },
      ...
      { type: 'p', text: 'אנחנו רוצים להסתכל גם על סוג החלבון, כמות החלבון, שומן, היחסים בין נוטריינטים, האיזון בין חומצות השומן אומגה 6 ואומגה 3, אנטיאוקסידנטים, ירקות ועוד ועוד...' },
      { type: 'p', text: 'כמובן שאנחנו רוצים להסתכל גם על הכלב עצמו: גיל, משקל, רמת פעילות, מצב גופני, רגישויות, מצב רפואי והמטרות שלנו עבורו.' },
...
function ArticleCard({ article }) {
  return (
    <Link to={`/articles/${article.id}`} className="block group">
      <Card hover padding={false} className="cursor-pointer">
        <div className="p-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-sm font-semibold text-forest group-hover:text-olive-dark flex items-center gap-1 transition-colors">
              קראו עוד
